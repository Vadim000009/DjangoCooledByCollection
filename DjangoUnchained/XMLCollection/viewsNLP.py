...
def learnNLP(request):
    ...
    categoryList = ["Технологии", "В мире", "Автоновости", "В России", "Инопресса", "Медицина",
    ...
    articleList = [
        [2, 30, 34, 35, 62, 71, 87, 95, 104, 112, 117, 138, 154, 159, 162, 188, 196, 200, 207, 212, 217, 223, 229, 256,
         ...
         509, 513, 529, 533], # Технологии
        [22, 28, 50, 52, 53, 54, 59, 74, 77, 80, 86, 106, 121, 127, 128, 129, 131, 139, 142, 149, 157, 164, 167, 169,
         171, 172, 173, 177, 178, 184, 187, 211, 226, 231, 237, 240, 244, 245, 248, 258, 262, 265, 269, 273, 277,
         296, 302, 309, 312, 314],# В мире
        [41, 81, 99, 100, 105, 176, 192, 263, 293, 300, 333, 350, 374, 383, 411, 433, 456, 494, 518, 536, 615, 636, 662,
         682, 692, 714, 739, 753, 817, 829, 835, 933, 937, 947, 968, 1042, 1070, 1080, 1096, 1105],# Автоновости
        ...
        [12, 18, 27, 58, 75, 84, 143, 155, 183, 227, 252, 338, 345, 353, 357, 406, 451, 489, 504, 524, 651, 666, 724,
         ...
         1353, 1383, 1399, 1486, 1508, 1587, 1590], # Недвижимость
        [166, 292, 310, 349, 487, 550, 577, 583, 669, 710, 731, 857, 893, 945, 1051, 1276, 1413, 1472, 1574, 1628], # Культура
        [44, 88, 175, 195, 219, 239, 275, 330, 367, 640, 659, 712, 823, 862, 881, 902, 930, 948, 966, 970, 1024, 1076,
         1097, 1099, 1157, 1261, 1302, 1361, 1427, 1490, 1537, 1548, 1558, 1569, 1636] # Экономика
    ]
    articleTexts = []
